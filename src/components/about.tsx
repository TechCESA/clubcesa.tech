export default function About() {
  return (
    <div
      id='about'
      className="relative mb-12 mt-28 h-[115vh] w-full overflow-hidden bg-[url('/01.gif')] bg-cover bg-center md:h-screen"
    >
      <div className='absolute -left-8 -top-10 z-10 h-[80px] w-[110%] bg-black blur-xl'></div>
      <div className='absolute -bottom-10 -left-8 z-10 h-[80px] w-[110%] bg-black blur-xl'></div>
      <div className='mx-auto flex h-full max-w-7xl flex-col items-start justify-center px-4 backdrop-blur-xl backdrop-filter sm:px-6 lg:px-8'>
