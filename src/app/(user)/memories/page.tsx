...
export default function Page() {
  return (
    <div className='container mx-auto my-20 grid select-none grid-cols-1 gap-4 sm:grid-cols-2'>
      <Card className='flex items-center justify-center overflow-hidden rounded-lg'>
        <CardHeader>
      ...
      <div className='grid gap-4'>
        <Link
          ...
          target='_blank'
          className='relative row-span-8 block h-64 overflow-hidden rounded-lg shadow-lg'
        >
          <Image
            className='h-48 object-cover blur-[1px]'
            src={
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
          <Link
            ...
            target='_blank'
            className='relative row-span-5 block h-40 overflow-hidden rounded-lg shadow-lg'
          >
            <Image
              className='h-48 object-cover blur-[1px]'
              src={
          ...
          <Link
            ...
            target='_blank'
            className='relative row-span-3 block h-24 overflow-hidden rounded-lg shadow-lg'
          >
            <Image
              className='h-48 object-cover blur-[1px]'
              src={
